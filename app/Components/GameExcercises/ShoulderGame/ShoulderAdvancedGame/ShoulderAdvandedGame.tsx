...
const ShoulderAdvancedGame = () => {
  ...
  const handleNextExercise = () => {
    setPoints(points + 10);
    if (currentIndex < ShoulderAdvanced.length - 1) {
  ...
  return (
    <View style={styles.container2}>
      <View style={styles.card} key={key}>         
        <Image 
          key={currentIndex}
          source={ShoulderAdvanced[currentIndex].image} 
          style={styles.image} 
        />
        <Text style={styles.exerciseName}>{ShoulderAdvanced[currentIndex].name}</Text>
      </View>
...
export default ShoulderAdvancedGame;
